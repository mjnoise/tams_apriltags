...
def generate_launch_description():
    ...
    declared_args = [
        ...
        DeclareLaunchArgument("robot_pose", default_value="0.0 0.0 1.001 0.0 0.0 0.0"),
        ...
        DeclareLaunchArgument('poses', default_value='0.5 0 1.001 0 0 0;-0.5 0.3 1.001 0 0 0'),
    ...
    box_spawn_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            ...
            "/launch/multicube_tams.launch.py"
        ]),
        launch_arguments={
    ...
    table_spawn_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("tams_apriltags"),
            "/launch/table.launch.py"
        ]),
        launch_arguments={
            "name": "table",
    ...
    return LaunchDescription(declared_args + [table_spawn_launch, box_spawn_launch, kortex_launch])
